...
var FabnaviApp = React.createClass({
  ...
  render: function () {
    return React.createElement("footer", { className: "belt" });
  },
...
var MenuIcon = React.createClass({
  ...
  render: function () {
    return React.createElement(
      "a",
      { className: "menu-action nav-action" },
      React.createElement("img", { src: this.props.src, onClick: this.onclick })
    );
  },
  ...
  render: function () {
    ...
    if (this.state.account.email != "") {
      menu = React.createElement(
        "div",
        { className: "menu" },
        React.createElement(MenuIcon, { act: "TOP", src: "images/h_top.png" }),
        React.createElement(MenuIcon, { act: "MY_PROJECT", src: "images/h_myproject.png" }),
        React.createElement(MenuIcon, { act: "NEW_PROJECT", src: "images/h_create.png" }),
        React.createElement(MenuIcon, { act: "CONFIG", src: "images/h_config.png" }),
        React.createElement(MenuIcon, { act: "SIGN_OUT", src: "images/h_sign_out.png" })
      );
    } else {
      menu = React.createElement(
        "div",
        { className: "menu" },
        React.createElement(MenuIcon, { act: "TOP", src: "images/h_top.png" }),
        React.createElement(MenuIcon, { act: "SIGN_IN", src: "images/h_signin.png" })
      );
    }
    return React.createElement(
      "div",
      ...
      React.createElement(
        "a",
        { className: "logo", href: "/" },
        React.createElement("img", { src: this.props.headerSrc })
      ),
      menu
    );
  },
  ...
  render: function () {
    return React.createElement(
      "div",
      { className: "project-box project" },
      React.createElement(
        "div",
        { className: "thumbnail" },
        React.createElement("img", { src: this.getThumbnailSrc() })
      ),
      React.createElement(
        "div",
  ...
  render: function () {
    ...
    this.state.projects.forEach(function (project) {
      projects.push(React.createElement(ProjectElement, { project: project }));
    });
    return React.createElement(
      "div",
      { className: "projects" },
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        "div",
        { className: "menu-action search-bar" },
        React.createElement(
          "form",
          null,
          React.createElement("input", { id: "search-box", onChange: this.handleChange }),
